game.StarterGui:SetCore("SendNotification", {
    Icon = "rbxassetid://10509313657";
    Title = "Chiba HuB", 
    Text = "Welecome To Chiba HuB"
})
...
local ScreenGui = Instance.new("ScreenGui")
    ...
    Toggle.Position = UDim2.new(0.001, 0, 0.52, 0)--(0.120833337, 0, 0.0952890813, 0)
	...
	LogoToggle.Position = UDim2.new(0, 0, 0, 0)
	LogoToggle.Size = UDim2.new(0,50 , 0, 50)
	LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(10509313657)
...
_G.Color = Color3.fromRGB(224,255,255)
...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Chiba Hub BF ') then
        makefolder('Chiba Hub BF')
    end
    if not _G.Dis and not isfile('Chiba Hub BF /'..Name..'.json') then
        writefile('Chiba Hub BF /'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Chiba Hub BF Premium') and isfile('Chiba Hub BF /'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Chiba Hub BF /'..Name..'.json'))
...
getgenv()['Update_Setting'] = function(Name)
    if not _G.Dis and isfolder('Chiba Hub BF Premium') and isfile('Chiba Hub BF /'..Name..'.json') then
        writefile('Chiba Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
	elseif not _G.Dis then
        Check_Setting(Name)
    end
end
...
function Text(value)
    game.StarterGui:SetCore("SendNotification", {
        Title = "Chiba Notification", 
        Text = tostring(value),
        Icon = "http://www.roblox.com/asset/?id=10509313657",
        Duration = 10
    })
end
function Com()
...
if IKAI then
	...
	function library:Window(text,text2,text3,logo,keybind)
		...
		ToggleImgUi.Image = "rbxassetid://10509313657"
	...
	Framefps.Size = UDim2.new(0, 113, 0, 24)
	...
	TextLabelfps.BackgroundTransparency = 0.200
	...
	TextLabeltime.BackgroundTransparency = 0.100
	...
	ImageLabelfps.Image = "rbxassetid://10509313657"
	...
	ImageLabeltime.Image = "rbxassetid://10509313657"
...
local win = library:Window("Chiba",[[ HuB]],[[Version : Premium ]],"10509313657",Enum.KeyCode.RightControl)
local General_Tab = win:Tab("General",[[7040391851]])
local Quest_Tab = win:Tab("Item",[[9606626859]])
...
General_Tab:Toggle("Fast Attack 1","9606294253",_G.Setting_table.FastAttack,function(vu)
